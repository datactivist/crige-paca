---
title: "Une brève histoire de l'open data"
subtitle: "Définitions, enjeux, accélérateurs et barrières."
author: "Samuel Goëta (@samgoeta)"
date: " Journée Technique sur l'Open Data, CRIGE PACA"
output:
...
Cette présentation est en ligne et librement réutilisable : http://datactivi.st/crige-paca/

Toutes les sources figurent ici : http://github.com/datactivist/crige-paca/
...
---
# Au final, des politiques d'open data "de l'offre"
.pull-left[
...
---
## En coulisses, un travail invisible fait de frictions
.reduite[
![](img/iceberg.png)
]
---
...
---
# Notre proposition : DODOdata pour réveiller les données qui dorment
.pull-left[
![](img/dododata.png)
]
.pull-right[
